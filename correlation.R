...
#text(10, 1, paste("Spearman cor ", round(cor(c1,c2,method="spearman"), 3)) ,cex = 1.2)
#dev.off()
...
plot(log(m1_a$val.x, 2), log(m1_a$val.y, 2), main=a, xlab="log2 counts in replicate 1", ylab="log2 counts in replicate 2", cex.lab=1.2,  col="black")
...
plot(log(m2_a$val.x, 2), log(m2_a$val.y, 2), main=a, xlab="log2 counts in replicate 1", ylab="log2 counts in replicate 3", cex.lab=1.2, col="black")
...
plot(log(m3_a$val.x, 2), log(m3_a$val.y, 2), main=a, xlab="log2 counts in replicate 2", ylab="log2 counts in replicate 3", cex.lab=1.2, col="black")
