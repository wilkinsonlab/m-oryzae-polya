...
sck.recv(1024)
sck.send("load /media/marco/Elements/EXP5/genomic_based/visualization/bowtie/WT_2.sorted.bam\n")
sck.recv(1024)
sck.send("load /media/marco/Elements/EXP5/genomic_based/visualization/bowtie/exp5_2.sorted.bam\n")
sck.recv(1024)
sck.send("load /media/marco/Elements/EXP5/genomic_based/visualization/bowtie/rbp35_2.sorted.bam\n")
sck.recv(1024)
