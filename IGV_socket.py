...
sck.recv(1024)
sck.send("load /media/marco/Elements/EXP5/genomic_based/visualization/segemehl/WT_1.sorted.bam\n")
sck.recv(1024)
sck.send("load /media/marco/Elements/EXP5/genomic_based/visualization/segemehl/WT_2.sorted.bam\n")
sck.recv(1024)
sck.send("load /media/marco/Elements/EXP5/genomic_based/visualization/segemehl/WT_3.sorted.bam\n")
sck.recv(1024)
sck.send("load /media/marco/Elements/EXP5/genomic_based/visualization/segemehl/rbp35_1.sorted.bam\n")
sck.recv(1024)
sck.send("load /media/marco/Elements/EXP5/genomic_based/visualization/segemehl/rbp35_2.sorted.bam\n")
sck.recv(1024)
sck.send("load /media/marco/Elements/EXP5/genomic_based/visualization/segemehl/rbp35_3.sorted.bam\n")
sck.recv(1024)
